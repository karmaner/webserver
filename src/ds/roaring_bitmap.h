#ifndef __SRC_DS_ROARING_BITMAP_H__
#define __SRC_DS_ROARING_BITMAP_H__
...
public:
    ...
    void writeTo(webserver::ByteArray::ptr ba) const;
    bool readFrom(webserver::ByteArray::ptr ba);
