#ifndef __SRC_STREAMS_ASYNC_SOCKET_STREAM_H__
#define __SRC_STREAMS_ASYNC_SOCKET_STREAM_H__
...
protected:
    ...
    bool waitFiber();
protected:
    webserver::FiberSemaphore m_sem;
    webserver::FiberSemaphore m_waitSem;
