...
static webserver::ConfigVar<uint32_t>::ptr g_rock_protocol_gzip_min_length
    = webserver::Config::Lookup("rock.protocol.gzip_min_length",
...
Message::ptr RockMessageDecoder::parseFrom(Stream::ptr stream) {
    try {
        ...
        WEBSERVER_LOG_ERROR(g_logger) << "RockMessageDecoder exceept";
    }
    return nullptr;
}
