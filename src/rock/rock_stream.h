#ifndef __SRC_ROCK_ROCK_STREAM_H__
#define __SRC_ROCK_ROCK_STREAM_H__
...
class RockStream : public webserver::AsyncSocketStream {
public:
    typedef std::shared_ptr<RockStream> ptr;
    typedef std::function<bool(webserver::RockRequest::ptr
                                ,webserver::RockResponse::ptr
                                ,webserver::RockStream::ptr)> request_handler;
    typedef std::function<bool(webserver::RockNotify::ptr
...
protected:
    ...
    void handleRequest(webserver::RockRequest::ptr req);
    void handleNotify(webserver::RockNotify::ptr nty);
private:
