...
class RegisterInfo final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::webserver::ns::Node* release_node();
...
inline const ::webserver::ns::Node& RegisterInfo::_internal_node() const {
  const ::webserver::ns::Node* p = _impl_.node_;
...
inline ::webserver::ns::Node* RegisterInfo::release_node() {
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::webserver::ns::Node* temp = _impl_.node_;
...
inline ::webserver::ns::Node* RegisterInfo::_internal_mutable_node() {
  ...
  if (_impl_.node_ == nullptr) {
    auto* p = CreateMaybeMessage<::webserver::ns::Node>(GetArenaForAllocation());
    _impl_.node_ = p;
  }
  return _impl_.node_;
}
inline ::webserver::ns::Node* RegisterInfo::mutable_node() {
  ::webserver::ns::Node* _msg = _internal_mutable_node();
...
inline ::webserver::ns::RegisterInfo* RegisterRequest::add_infos() {
  ::webserver::ns::RegisterInfo* _add = _internal_add_infos();
...
inline ::webserver::ns::Node* NodeInfo::add_nodes() {
  ::webserver::ns::Node* _add = _internal_add_nodes();
...
inline ::webserver::ns::NodeInfo* QueryResponse::add_infos() {
  ::webserver::ns::NodeInfo* _add = _internal_add_infos();
...
inline ::webserver::ns::NodeInfo* NotifyMessage::add_dels() {
  ::webserver::ns::NodeInfo* _add = _internal_add_dels();
...
inline ::webserver::ns::NodeInfo* NotifyMessage::add_updates() {
  ::webserver::ns::NodeInfo* _add = _internal_add_updates();
