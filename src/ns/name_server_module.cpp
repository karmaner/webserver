...
bool NameServerModule::handleRockRequest(webserver::RockRequest::ptr request
                                            ,webserver::RockResponse::ptr response
                                            ,webserver::RockStream::ptr stream) {
    webserver::Atomic::addFetch(s_request_count, 1);
...
bool NameServerModule::handleRockNotify(webserver::RockNotify::ptr notify
                                        ,webserver::RockStream::ptr stream) {
    return true;
}

bool NameServerModule::onConnect(webserver::Stream::ptr stream) {
...
bool NameServerModule::onDisconnect(webserver::Stream::ptr stream) {
...
NSClientInfo::ptr NameServerModule::get(webserver::RockStream::ptr rs) {
    webserver::RWMutex::ReadLock lock(m_mutex);
    auto it = m_sessions.find(rs);
    return it == m_sessions.end() ? nullptr : it->second;
}

bool NameServerModule::handleRegister(webserver::RockRequest::ptr request
                                        ,webserver::RockResponse::ptr response
                                        ,webserver::RockStream::ptr stream) {
...
void NameServerModule::set(webserver::RockStream::ptr rs, NSClientInfo::ptr new_value) {
    if(!rs->isConnected()) {
        new_value = nullptr;
    }
    ...
    //webserver::WorkerMgr::GetInstance()->schedule("notify",
...
std::set<webserver::RockStream::ptr> NameServerModule::getStreams(const std::string& domain) {
    webserver::RWMutex::ReadLock lock(m_mutex);
    auto it = m_domainToSessions.find(domain);
    return it == m_domainToSessions.end() ? std::set<webserver::RockStream::ptr>() : it->second;
}
...
bool NameServerModule::handleQuery(webserver::RockRequest::ptr request
                                    ,webserver::RockResponse::ptr response
                                    ,webserver::RockStream::ptr stream) {
...
void NameServerModule::setQueryDomain(webserver::RockStream::ptr rs, const std::set<std::string>& ds) {
...
bool NameServerModule::handleTick(webserver::RockRequest::ptr request
                                    ,webserver::RockResponse::ptr response
                                    ,webserver::RockStream::ptr stream) {
    return true;
}
