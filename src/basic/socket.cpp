...
bool Socket::bind(const Address::ptr addr) {
    ...
    if(uaddr) {
        ...
        if(sock->connect(uaddr)) {
            ...
            webserver::FSUtil::Unlink(uaddr->getPath(), true);
        }
    }
...
bool Socket::cancelRead() {
    return IOManager::GetThis()->cancelEvent(m_sock, webserver::IOManager::READ);
}

bool Socket::cancelWrite() {
    return IOManager::GetThis()->cancelEvent(m_sock, webserver::IOManager::WRITE);
}
