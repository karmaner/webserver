...
unsigned int sleep(unsigned int seconds) {
    ...
    webserver::IOManager* iom = webserver::IOManager::GetThis();
    iom->addTimer(seconds * 1000, std::bind((void(webserver::Scheduler::*)
...
int usleep(useconds_t usec) {
    ...
    webserver::Fiber::ptr fiber = webserver::Fiber::GetThis();
    webserver::IOManager* iom = webserver::IOManager::GetThis();
    iom->addTimer(usec / 1000, std::bind((void(webserver::Scheduler::*)
            (webserver::Fiber::ptr, int thread))&webserver::IOManager::schedule
            ,iom, fiber, -1));
    webserver::Fiber::YieldToHold();
    return 0;
...
int nanosleep(const struct timespec *req, struct timespec *rem) {
    ...
    webserver::Fiber::ptr fiber = webserver::Fiber::GetThis();
    webserver::IOManager* iom = webserver::IOManager::GetThis();
    iom->addTimer(timeout_ms, std::bind((void(webserver::Scheduler::*)
            (webserver::Fiber::ptr, int thread))&webserver::IOManager::schedule
            ,iom, fiber, -1));
    webserver::Fiber::YieldToHold();
    return 0;
